...
BUNDLE_IDENTIFIER=`plistutil -i tmp/Payload/$IPASubDirName.app/Info.plist | xml2 | grep -A 1 CFBundleIdentifier | tail -n1 | cut -d '=' -f 2`
BUNDLE_VERSION=`plistutil -i tmp/Payload/$IPASubDirName.app/Info.plist | xml2 | grep -A 1 CFBundleVersion | tail -n1 | cut -d '=' -f 2`
BUNDLE_SHORTVERSION=`plistutil -i tmp/Payload/$IPASubDirName.app/Info.plist | xml2 | grep -A 1 CFBundleShortVersionString | tail -n1 | cut -d '=' -f 2`
BUNDLE_TITLE=`plistutil -i tmp/Payload/$IPASubDirName.app/Info.plist | xml2 | grep -A 1 CFBundleDisplayName | tail -n1 | cut -d '=' -f 2`
BUNDLE_NAME=`plistutil -i tmp/Payload/$IPASubDirName.app/Info.plist | xml2 | grep -A 1 CFBundleName | tail -n1 | cut -d '=' -f 2`
[[ ${#BUNDLE_TITLE} == 0 ]] && BUNDLE_TITLE=$BUNDLE_NAME;
MINIMUM_OSVERSION=`plistutil -i tmp/Payload/$IPASubDirName.app/Info.plist | xml2 | grep -A 1 MinimumOSVersion | tail -n1 | cut -d '=' -f 2`
ICON_FILENAME=`plistutil -i tmp/Payload/$IPASubDirName.app/Info.plist | xml2 | grep -A 1 CFBundleIconFile | tail -n1 | cut -d '=' -f 2`
